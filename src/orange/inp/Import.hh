 ...
 * - implicit_parent_boundary to be true (see
 * https://github.com/celeritas-project/celeritas/issues/2012 )
 *
 * \todo Add IO for this separately; currently only FromGeant is supported.
 */
struct OrangeGeoFromCsg
{
    //!@{
 ...
 */
struct OrangeGeoFromGeant : public OrangeGeoFromCsg
{
    //!@{
    //! \name Volume-to-universe conversion
