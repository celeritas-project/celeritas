 ...
 * \f]
 * has n solutions mathematically, but we only want solutions where t is results
...
class InvoluteSolver
{
  public:
    ...
    //!@}
    static inline CELER_FUNCTION Intersections solve(
  ...
  public:
    ...
    inline CELER_FUNCTION Intersections operator()(real_type x, real_type y, 
 ...
 */
CELER_FUNCTION InvoluteSolver::InvoluteSolver(real_type r_b, 
 ...
 */
CELER_FUNCTION auto InvoluteSolver::solve(real_type x, real_type y, real_type z, 
