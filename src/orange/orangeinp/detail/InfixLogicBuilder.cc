...
//---------------------------------------------------------------------------//
//! \file orange/orangeinp/detail/InfixLogicBuilder.cc
//---------------------------------------------------------------------------//
#include "InfixLogicBuilder.hh"
...
class InfixLogicBuilderImpl
{
  ...
  public:
    ...
    inline InfixLogicBuilderImpl(CsgTree const& tree,
                                 VecSurface const* vs,
                                 VecLogic* logic);
 ...
 */
InfixLogicBuilderImpl::InfixLogicBuilderImpl(CsgTree const& tree,
                                             VecSurface const* vs,
                                             VecLogic* logic)
 ...
 * Build from a node ID.
 */
void InfixLogicBuilderImpl::operator()(NodeId const& n)
{
    visit_node_(*this, n);
}
 ...
 */
void InfixLogicBuilderImpl::operator()(True const&)
{
 ...
 */
void InfixLogicBuilderImpl::operator()(False const&)
{
 ...
 * Push a surface ID.
 */
void InfixLogicBuilderImpl::operator()(Surface const& s)
{
 ...
 */
void InfixLogicBuilderImpl::operator()(Aliased const& n)
{
    (*this)(n.node);
}
 ...
 * Visit a negated node and append 'not'.
 */
void InfixLogicBuilderImpl::operator()(Negated const& n)
{
 ...
 * Visit daughter nodes and append the conjunction.
 */
void InfixLogicBuilderImpl::operator()(Joined const& n)
{
 ...
 */
auto InfixLogicBuilder::operator()(NodeId n) const -> result_type
{
    CELER_EXPECT(n < tree_.size());

    // Construct logic vector as local surface IDs
    VecLogic lgc;
    InfixLogicBuilderImpl build_impl{tree_, mapping_, &lgc};
    build_impl(n);
