...
class DistributionInserter
{
  public:
    ...
    OnedDistributionId operator()(
        inp::TruncatedDistribution<inp::NormalDistribution> const&);

    // Add 3D distribution data
    ThreedDistributionId operator()(
        inp::DeltaDistribution<Array<double, 3>> const&);
