...
CELER_FUNCTION Interaction MuBremsstrahlungInteractor::operator()(Engine& rng)
{
    ...
    ReciprocalDistribution<real_type> sample_epsilon(min_inc_kinetic_energy,
                                                     inc_energy_.value());
