...
//---------------------------------------------------------------------------//
//! \file celeritas/em/process/ElectroNuclearProcess.hh
//---------------------------------------------------------------------------//
#pragma once
...
//---------------------------------------------------------------------------//
/*!
 * Electro-nuclear process.
 */
class ElectroNuclearProcess : public Process
{
  public:
    //!@{
    //! \name Type aliases
  ...
  public:
    ...
    ElectroNuclearProcess(SPConstParticles particles,
