...
class MollerEnergyDistribution
{
  ...
  public:
    ...
    inline CELER_FUNCTION MollerEnergyDistribution(
...
CELER_FUNCTION real_type MollerEnergyDistribution::operator()(Engine& rng)
{
    ...
    } while (reject(calc_g_fraction(epsilon), rng));
 ...
 */
CELER_FUNCTION real_type MollerEnergyDistribution::calc_g_fraction(
    real_type epsilon)
{
