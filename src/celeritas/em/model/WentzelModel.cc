...
{
    CELER_EXPECT(z);
    static const real_type mott_coeffs[WentzelElementData::num_mott_elements][WentzelElementData::num_mott_theta_bins][WentzelElementData::num_mott_beta_bins] = {
        // H.......................................
    ...
    WentzelElementData::MottCoeffMatrix coeffs;
    for (auto i : range(coeffs.size()))
    {
        for (auto j : range(coeffs[i].size()))
        {
            coeffs[i][j] = mott_coeffs[index][i][j];
        }
    }
    return coeffs;
}
