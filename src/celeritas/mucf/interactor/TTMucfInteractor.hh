...
//---------------------------------------------------------------------------//
//! \file celeritas/mucf/interactor/TTMucfInteractor.hh
//---------------------------------------------------------------------------//
#pragma once
...
//---------------------------------------------------------------------------//
/*!
 * Muon-catalyzed fusion of \f$ (tt)_\mu \f$ molecules.
 *
 * This is an \em at-rest interaction.
 */
class TTMucfInteractor
{
  public:
    enum class Channel
    {
        alpha_muon_neutron_neutron,  //!< \f$ \alpha + \mu + n + n \f$
        muonicalpha_neutron_neutron,  //!< \f$ (\alpha)_\mu + n + n \f$
        size_
    };
 ...
 */
CELER_FUNCTION size_type TTMucfInteractor::num_secondaries() const
{
    switch (channel_)
    {
        case Channel::alpha_muon_neutron_neutron:
            return 4;
        case Channel::muonicalpha_neutron_neutron:
            return 3;
        default:
