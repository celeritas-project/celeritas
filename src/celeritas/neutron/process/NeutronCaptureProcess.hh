...
//---------------------------------------------------------------------------//
//! \file celeritas/neutron/process/NeutronCaptureProcess.hh
//---------------------------------------------------------------------------//
#pragma once
...
//---------------------------------------------------------------------------//
/*!
 * Capture process for neutrons.
 */
class NeutronCaptureProcess : public Process
{
  public:
    //!@{
    //! \name Type aliases
  ...
  public:
    ...
    NeutronCaptureProcess(SPConstParticles particles,
