                                         ...
                                         ReadData load_data)
{
    ...
    mirror_ = CollectionMirror<NeutronCaptureData>{std::move(data)};
 ...
 */
auto NeutronCaptureModel::micro_xs(Applicability) const -> MicroXsBuilders
{
 ...
 */
void NeutronCaptureModel::execute(CoreParams const& params,
...
//---------------------------------------------------------------------------//
#if !CELER_USE_DEVICE
void NeutronCaptureModel::execute(CoreParams const&, CoreStateDevice&) const
{
 ...
 */
ActionId NeutronCaptureModel::action_id() const
{
...
//---------------------------------------------------------------------------//
/*!
 * Construct neutron capture cross section data for a single element.
 */
void NeutronCaptureModel::append_xs(ImportPhysicsVector const& inp,
