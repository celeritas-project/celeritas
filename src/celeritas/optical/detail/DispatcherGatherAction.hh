...
//---------------------------------------------------------------------------//
//! \file celeritas/optical/detail/DispatcherGatherAction.hh
//---------------------------------------------------------------------------//
#pragma once
 ...
 */
class DispatcherGatherAction final : public ExplicitCoreActionInterface
{
  public:
    //!@{
    //! \name Type aliases
  ...
  public:
    ...
    DispatcherGatherAction(ActionId id, AuxId data_id);
