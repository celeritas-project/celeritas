...
//---------------------------------------------------------------------------//
//! \file celeritas/optical/gen/detail/CherenkovOffloadAction.cc
//---------------------------------------------------------------------------//
 ...
 */
CherenkovOffloadAction::CherenkovOffloadAction(ActionId action_id,
                                               AuxId step_id,
                                               AuxId gen_id,
                                               AuxId optical_id,
...
//---------------------------------------------------------------------------//
#if !CELER_USE_DEVICE
void CherenkovOffloadAction::offload(CoreParams const&, CoreStateDevice&) const
{
