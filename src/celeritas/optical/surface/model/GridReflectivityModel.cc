    ...
    : SurfaceModel(id, "grid-reflectivity")
{
    ...
    for (auto const& [surface, refl] : layer_map)
    {
        ...
        CELER_VALIDATE(r_grid,
                       << "a valid reflectivity grid is required for user-defined grid reflectivity model");
        ...
        CELER_VALIDATE(t_grid,
                       << "a valid transmittance grid is required for user-defined grid reflectivity model");
