...
using CoreParamsDeviceRef = ::celeritas::DeviceCRef<CoreParamsData>;
using CoreParamsHostRef   = ::celeritas::HostCRef<CoreParamsData>;
using CoreStateDeviceRef  = ::celeritas::DeviceRef<CoreStateData>;
using CoreStateHostRef    = ::celeritas::HostRef<CoreStateData>;
...
inline void resize(CoreStateData<Ownership::value, M>*          state,
                   const ::celeritas::HostCRef<CoreParamsData>& params,
                   size_type                                    size)
{
    CELER_EXPECT(state);
    CELER_EXPECT(params);
