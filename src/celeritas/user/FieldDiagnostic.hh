...
//---------------------------------------------------------------------------//
//! \file celeritas/user/FieldDiagnostic.hh
//---------------------------------------------------------------------------//
#pragma once
...
//---------------------------------------------------------------------------//
/*!
 * Record the number of field substeps vs. track energy.
 */
class FieldDiagnostic final : public ExplicitActionInterface,
                              public OutputInterface
{
  ...
  public:
    ...
    std::string label() const final { return "field-diagnostic"; }
