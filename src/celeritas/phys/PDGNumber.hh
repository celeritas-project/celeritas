...
CELER_DEFINE_PDGNUMBER(electron_neutrino, 12)
CELER_DEFINE_PDGNUMBER(anti_electron_neutrino, -12)
CELER_DEFINE_PDGNUMBER(mu_minus, 13)
CELER_DEFINE_PDGNUMBER(mu_plus, -13)
CELER_DEFINE_PDGNUMBER(mu_neutrino, 14)
CELER_DEFINE_PDGNUMBER(anti_mu_neutrino, -14)
