...
ScopedRootErrorHandler::ScopedRootErrorHandler()
    ...
    , prev_errored_{has_root_errored_}
{
...
{
    bool prev_errored = has_root_errored_;
    has_root_errored_ = false;
...
ScopedRootErrorHandler::~ScopedRootErrorHandler()
{
    ...
    has_root_errored_ = prev_errored_;
}
