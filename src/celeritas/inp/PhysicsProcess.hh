 ...
 * the final cycle rate (a \c real_type ) for each molecule + spin being needed
 ...
 * combinations being the \c vector<AtomTransferRateData> in \c MucfPhysics .
 *
 ...
 *
 * Each struct holds one of such combinations, with the full set of
 * combinations being the \c vector<AtomSpinFlipRateData> in \c MucfPhysics .
 *
