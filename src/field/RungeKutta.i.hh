 ...
 */
OdeArray<real_type, 6>
RungeKutta::stepper(real_type h, const ode_type& y, const ode_type& dydx)
{
    ...
    // return the final state: initial + average slope at 4-points
    ode_type yout = y + h * (dydx + dydxt_ + 2.0 * dydxm_) / 6.0;
    return yout;
}
//---------------------------------------------------------------------------//
} // namespace celeritas
