...
struct VecgeomScalars
{
    ...
    {
        return host_world != nullptr && volume_depth > 0;
    }
};
...
#endif
    data->vgstate.resize(params.scalars.volume_depth, size);
    data->vgnext.resize(params.scalars.volume_depth, size);
