...
<<<<<<< HEAD class G4ParticleDefinition;
=======
#include "corecel/cont/Span.hh"
#include "accel/TrackOffloadInterface.hh"

#include "detail/IntegrationSingleton.hh"
    >>>>>>> 29c8c140d (Add optical track-offload option and integrate with constructor)
#include "corecel/cont/Span.hh"
#include "accel/TrackOffloadInterface.hh"
    ...
    namespace celeritas
{
     ...
     * \code
       ...
       \endcode
     *
     * but for manual integration it can be constructed with a function to get
     a
     * reference to the thread-local \c LocalTransporter from the Geant4 thread
     ID:
     * \code
        auto* physics_list = new FTFP_BERT;
        physics_list->RegisterPhysics(new TrackingManagerConstructor{
