 ...
 * na_avogadro    | Avogadro
 * re_electron    | classic_electr_radius
 *
...
constexpr real_type a0_bohr              = 5.29177210903e-11 * units::meter; //!< Bohr radius
...
constexpr real_type eps_electric         = 8.8541878128e-12 * units::farad / units::meter; //!< vacuum permittivity
constexpr real_type mu_magnetic          = 1.25663706212e-6 * units::newton / (units::ampere * units::ampere); //!< vacuum permeability
constexpr real_type re_electron          = 2.8179403262e-15 * units::meter; //!< classical electron radius
