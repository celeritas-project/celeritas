...
class span
{
    ...
    static_assert(detail::is_complete<ElementType>::value,
                  "A span's ElementType must be a complete type (not a "
                  "forward "
                  "declaration)");
  ...
  public:
    ...
    TCB_SPAN_CONSTEXPR size_type size() const noexcept
    {
        return storage_.size;
    }

    TCB_SPAN_CONSTEXPR size_type size_bytes() const noexcept
    {
    ...
    TCB_SPAN_CONSTEXPR iterator end() const noexcept
    {
        return data() + size();
    }

    TCB_SPAN_CONSTEXPR const_iterator cbegin() const noexcept
    {
        return begin();
    }
...
TCB_SPAN_CONSTEXPR span<typename Container::value_type>
