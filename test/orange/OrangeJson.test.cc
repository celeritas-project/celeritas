...
TEST_F(UniversesTest, TEST_IF_CELERITAS_DOUBLE(output))
{
    ...
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":3,"max_faces":14,"max_intersections":14,"max_logic_levels":3,"tol":{"abs":1.5e-08,"rel":1.5e-08}},"sizes":{"bih":{"bboxes":12,"inner_nodes":6,"leaf_nodes":9,"local_volume_ids":10},"connectivity_records":25,"daughters":3,"fast_real3s":0,"local_surface_ids":55,"local_volume_ids":21,"logic_ints":171,"obz_records":0,"real_ids":25,"reals":24,"rect_arrays":0,"simple_units":3,"surface_types":25,"transforms":3,"universe_indexer":{"surfaces":4,"volumes":4},"universe_indices":3,"universe_types":3,"volume_ids":12,"volume_instance_ids":12,"volume_records":12}})json",
        to_string(out));
}
...
TEST_F(HexArrayTest, TEST_IF_CELERITAS_DOUBLE(output))
{
    ...
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":3,"max_faces":9,"max_intersections":10,"max_logic_levels":3,"tol":{"abs":1.5e-08,"rel":1.5e-08}},"sizes":{"bih":{"bboxes":58,"inner_nodes":49,"leaf_nodes":53,"local_volume_ids":55},"connectivity_records":53,"daughters":51,"fast_real3s":0,"local_surface_ids":191,"local_volume_ids":348,"logic_ints":585,"obz_records":0,"real_ids":53,"reals":272,"rect_arrays":0,"simple_units":4,"surface_types":53,"transforms":51,"universe_indexer":{"surfaces":5,"volumes":5},"universe_indices":4,"universe_types":4,"volume_ids":58,"volume_instance_ids":58,"volume_records":58}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, globalspheres)
{
    ...
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":1,"max_faces":2,"max_intersections":4,"max_logic_levels":2,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":3,"inner_nodes":0,"leaf_nodes":1,"local_volume_ids":3},"connectivity_records":2,"daughters":0,"fast_real3s":0,"local_surface_ids":4,"local_volume_ids":4,"logic_ints":7,"obz_records":0,"real_ids":2,"reals":2,"rect_arrays":0,"simple_units":1,"surface_types":2,"transforms":0,"universe_indexer":{"surfaces":2,"volumes":2},"universe_indices":1,"universe_types":1,"volume_ids":3,"volume_instance_ids":3,"volume_records":3}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, bgspheres)
{
    ...
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":1,"max_faces":3,"max_intersections":6,"max_logic_levels":1,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":4,"inner_nodes":1,"leaf_nodes":2,"local_volume_ids":3},"connectivity_records":3,"daughters":0,"fast_real3s":0,"local_surface_ids":6,"local_volume_ids":3,"logic_ints":5,"obz_records":0,"real_ids":3,"reals":9,"rect_arrays":0,"simple_units":1,"surface_types":3,"transforms":0,"universe_indexer":{"surfaces":2,"volumes":2},"universe_indices":1,"universe_types":1,"volume_ids":4,"volume_instance_ids":4,"volume_records":4}})json",
        to_string(out));
}
...
{"dir":[0.0,0.0,-1.0],"pos":[0.0,0.0,0.0],"universe":"d2","volume":{"impl":"d2@bg","local":1}}
    ...
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":3,"max_faces":8,"max_intersections":14,"max_logic_levels":3,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":24,"inner_nodes":9,"leaf_nodes":16,"local_volume_ids":13},"connectivity_records":13,"daughters":6,"fast_real3s":0,"local_surface_ids":20,"local_volume_ids":18,"logic_ints":31,"obz_records":0,"real_ids":13,"reals":46,"rect_arrays":0,"simple_units":7,"surface_types":13,"transforms":6,"universe_indexer":{"surfaces":8,"volumes":8},"universe_indices":7,"universe_types":7,"volume_ids":24,"volume_instance_ids":24,"volume_records":24}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, incomplete_bb)
{
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","scalars":{"num_univ_levels":2,"max_faces":6,"max_intersections":6,"max_logic_levels":2,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":6,"inner_nodes":1,"leaf_nodes":3,"local_volume_ids":5},"connectivity_records":8,"daughters":1,"fast_real3s":0,"local_surface_ids":10,"local_volume_ids":4,"logic_ints":38,"obz_records":0,"real_ids":8,"reals":26,"rect_arrays":0,"simple_units":2,"surface_types":8,"transforms":1,"universe_indexer":{"surfaces":3,"volumes":3},"universe_indices":2,"universe_types":2,"volume_ids":6,"volume_instance_ids":6,"volume_records":6}})json",
        to_string(out));
}
