...
TEST_F(UniversesTest, TEST_IF_CELERITAS_DOUBLE(output))
{
    ...
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","bih_metadata":{"max_depth":[4,3,1],"num_finite_bboxes":[4,4,1],"num_nonfinite_bboxes":[1,0,0]},"scalars":{"logic":"postfix","max_csg_levels":1,"max_faces":14,"max_intersections":14,"num_univ_levels":3,"tol":{"abs":1.5e-08,"rel":1.5e-08}},"sizes":{"bih":{"bboxes":12,"inner_nodes":6,"leaf_nodes":9,"local_volume_ids":10},"connectivity_records":25,"daughters":3,"fast_real3s":0,"local_surface_ids":55,"local_volume_ids":21,"logic_ints":164,"obz_records":0,"real_ids":25,"reals":24,"rect_arrays":0,"simple_units":3,"surface_types":25,"transforms":3,"univ_indices":3,"univ_types":3,"universe_indexer":{"surfaces":4,"volumes":4},"volume_ids":12,"volume_instance_ids":12,"volume_records":12}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, globalspheres)
{
    ...
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","bih_metadata":{"max_depth":[1],"num_finite_bboxes":[2],"num_nonfinite_bboxes":[1]},"scalars":{"logic":"postfix","max_csg_levels":1,"max_faces":2,"max_intersections":4,"num_univ_levels":1,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":3,"inner_nodes":0,"leaf_nodes":1,"local_volume_ids":3},"connectivity_records":2,"daughters":0,"fast_real3s":0,"local_surface_ids":4,"local_volume_ids":4,"logic_ints":7,"obz_records":0,"real_ids":2,"reals":2,"rect_arrays":0,"simple_units":1,"surface_types":2,"transforms":0,"univ_indices":1,"univ_types":1,"universe_indexer":{"surfaces":2,"volumes":2},"volume_ids":3,"volume_instance_ids":3,"volume_records":3}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, bgspheres)
{
    ...
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","bih_metadata":{"max_depth":[2],"num_finite_bboxes":[2],"num_nonfinite_bboxes":[1]},"scalars":{"logic":"postfix","max_csg_levels":1,"max_faces":3,"max_intersections":2,"num_univ_levels":1,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":4,"inner_nodes":1,"leaf_nodes":2,"local_volume_ids":3},"connectivity_records":3,"daughters":0,"fast_real3s":0,"local_surface_ids":6,"local_volume_ids":3,"logic_ints":5,"obz_records":0,"real_ids":3,"reals":9,"rect_arrays":0,"simple_units":1,"surface_types":3,"transforms":0,"univ_indices":1,"univ_types":1,"universe_indexer":{"surfaces":2,"volumes":2},"volume_ids":4,"volume_instance_ids":4,"volume_records":4}})json",
        to_string(out));
}
...
TEST_F(InputBuilderTest, incomplete_bb)
{
    OrangeParamsOutput out(this->geometry());
    EXPECT_JSON_EQ(
        R"json({"_category":"internal","_label":"orange","bih_metadata":{"max_depth":[2,1],"num_finite_bboxes":[2,1],"num_nonfinite_bboxes":[1,1]},"scalars":{"logic":"postfix","max_csg_levels":1,"max_faces":6,"max_intersections":6,"num_univ_levels":2,"tol":{"abs":1e-05,"rel":1e-05}},"sizes":{"bih":{"bboxes":6,"inner_nodes":1,"leaf_nodes":3,"local_volume_ids":5},"connectivity_records":8,"daughters":1,"fast_real3s":0,"local_surface_ids":10,"local_volume_ids":4,"logic_ints":37,"obz_records":0,"real_ids":8,"reals":26,"rect_arrays":0,"simple_units":2,"surface_types":8,"transforms":1,"univ_indices":2,"univ_types":2,"universe_indexer":{"surfaces":3,"volumes":3},"volume_ids":6,"volume_instance_ids":6,"volume_records":6}})json",
        to_string(out));
}
