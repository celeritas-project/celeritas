...
class CachedLazySenseCalculatorTest
    : public ::celeritas::test::OrangeGeoTestBase
{
  protected:
...
TEST_F(CachedLazySenseCalculatorTest, one_volume)
{
    {
        OneVolInput geo_inp;
    ...
    OnFace face;
    CachedLazySenseCalculator calc_senses(
...
TEST_F(CachedLazySenseCalculatorTest, two_volumes)
{
    {
        TwoVolInput geo_inp;
        geo_inp.radius = 1.5;
...

    {
        ...
        {
            OnFace face;
            CachedLazySenseCalculator calc_senses(this->make_surf_visitor(),
                                                  inner,
                                                  pos,
                                                  this->sense_storage(),
                                                  face);
...
TEST_F(CachedLazySenseCalculatorTest, five_volumes)
{
