...
TEST_F(ZnenvTest, debug)
{
    ...
    if (CELERITAS_UNITS == CELERITAS_UNITS_CGS)
    {
        EXPECT_JSON_EQ(
            R"json({"levels":[
{"dir":[1.0,0.0,0.0],"pos":[0.1,1e-4,0.0],"universe":"World","volume":{"impl":"ZNTX","instance":"ZNTX_PV@1","local":2}},
{"dir":[1.0,0.0,0.0],"pos":[-1.66,1e-4,0.0],"universe":"ZNTX","volume":{"impl":"ZN1","instance":"ZN1_PV@1","local":2}},
{"dir":[1.0,0.0,0.0],"pos":[-1.66,-1.76,0.0],"universe":"ZN1","volume":{"impl":"ZNSL","instance":"ZNSL_PV@0","local":1}},
{"dir":[1.0,0.0,0.0],"pos":[-1.66,-0.160,0.0],"universe":"ZNSL","volume":{"impl":"ZNST","instance":"ZNST_PV@0","local":1}},
{"dir":[1.0,0.0,0.0],"pos":[-0.0600,-0.160,0.0],"universe":"ZNST","volume":{"impl":"ZNST","instance":"ZNST_PV@0","local":5}}
],"surface":null})json",
