...
class UserActionIntegrationTest : public IntegrationTestBase
{
  protected:
...
void UserActionIntegrationTest::SetUpTestCase()
{
...
TEST_F(UserActionIntegrationTest, initialize)
{
    Base::run_manager().Initialize();
}

TEST_F(UserActionIntegrationTest, run)
{
