...
TEST(StringSimplifierTest, all)
{
    ...
    EXPECT_EQ("1234.0", simplify("1234."));
    EXPECT_EQ("1234.0", simplify("1234.0"));
    ...
    EXPECT_EQ("Single precision is 1.0, 2.0, 1.23, or -1.678",
    ...
    EXPECT_EQ("{-6.0, 0.0, 0.0} along local direction {1.0, 0.0, 0.0}",
    ...
    EXPECT_EQ("1234.0", simplify("1234."));
    EXPECT_EQ("1234.0", simplify("1234.f"));
    ...
    EXPECT_EQ("12.0 1.2e2 1.0e0", simplify_more("12.3456 123.45 1.0234e0"));
