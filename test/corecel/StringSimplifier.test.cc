...
TEST(StringSimplifierTest, all)
{
    ...
    EXPECT_EQ("0.001", simplify("0.001"));
    EXPECT_EQ("0.001", simplify("0.001"));
    EXPECT_EQ("0.001", simplify("0.001f"));
    EXPECT_EQ("-0.001", simplify("-0.001"));
    EXPECT_EQ("-0.001", simplify("-0.001f"));
    ...
    EXPECT_EQ("{-6, 0, 0} along local direction {1, 0, 0}",
              simplify("{-6, 0, 0} along local direction {1, 0, 0}"));
    EXPECT_EQ("Cone z: t=0.005 at {0,0,100}",
    ...
    EXPECT_EQ("0.001", simplify("0.001"));
    EXPECT_EQ("0.0001", simplify("0.0001"));
    EXPECT_EQ("0.00001", simplify("0.00001"));

    EXPECT_EQ("0.0", simplify("0.0f"));
    EXPECT_EQ("0.1", simplify("0.1f"));
    EXPECT_EQ("0.01", simplify("0.01f"));
    EXPECT_EQ("0.001", simplify("0.001f"));
    EXPECT_EQ("0.0001", simplify("0.0001f"));
    EXPECT_EQ("0.00001", simplify("0.00001f"));
