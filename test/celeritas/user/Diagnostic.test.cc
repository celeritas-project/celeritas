...
class TestEm3DiagnosticTestBase : public TestEm3Base,
...
#define TestEm3ActionDiagnosticTest \
    TEST_IF_CELERITAS_GEANT(TestEm3ActionDiagnosticTest)
class TestEm3ActionDiagnosticTest : public TestEm3DiagnosticTestBase,
                                    public ActionDiagnosticTestBase
{
};
...
TEST_F(TestEm3ActionDiagnosticTest, step_host)
{
...
TEST_F(TestEm3ActionDiagnosticTest, TEST_IF_CELER_DEVICE(step_device))
{
