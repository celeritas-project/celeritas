...
using DiagnosticDPStepper
    = DiagnosticStepper<celeritas::DormandPrinceStepper<E>>;
...
class FieldDriverTest : public Test
{
  public:
    ...
    using MevMass          = celeritas::units::MevMass;
    using MevMomentum      = celeritas::units::MevMomentum;
    using ElementaryCharge = celeritas::units::ElementaryCharge;
    ...
    Real3 calc_momentum(MevEnergy energy, Real3 const& dir)
    {
        ...
        return celeritas::detail::ax(this->calc_momentum(energy).value(), dir);
    }
