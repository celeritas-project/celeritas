...
TEST(JsonIO, standalone_input)
{
    ...
    input.problem.model.geometry = "geometry.gdml";
    input.problem.control.capacity = CoreStateCapacity::from_default(false);
