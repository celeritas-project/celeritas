...
class FourSteelSlabsEmStandard : public GeantImporterTest
{
    GeantSetup setup_geant() override
    {
        ...
        opts.atomic_relaxation = true;
#if CELERITAS_USE_JSON
        {
            nlohmann::json    out = opts;
            static const char expected[]
                = R"json({"atomic_relaxation":true,"brems":"all","coulomb_scattering":false,"eloss_fluctuation":true,"em_bins_per_decade":7,"integral_approach":true,"linear_loss_limit":0.01,"lpm":true,"max_energy":[100000000.0,"MeV"],"min_energy":[0.0001,"MeV"],"msc":"urban","rayleigh_scattering":true})json";
