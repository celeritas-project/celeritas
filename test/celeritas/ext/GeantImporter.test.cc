...
TEST_F(FourSteelSlabsEmStandard, eioni)
{
    ...
    ASSERT_EQ(2, tables.size());
    {
        ...
        EXPECT_SOFT_EQ(1e-4, steel.xmin);
        EXPECT_SOFT_EQ(1e8, steel.xmax);
    ...
    }
    {
        ...
        EXPECT_SOFT_NEAR(2.616556310615175, steel.xmin, tol);
        EXPECT_SOFT_EQ(1e8, steel.xmax);
...
TEST_F(FourSteelSlabsEmStandard, muioni)
{
    ...
    }
    {
        ...
        EXPECT_SOFT_NEAR(54.542938808612199, steel.xmin, tol);
        EXPECT_SOFT_EQ(1e8, steel.xmax);
        EXPECT_SOFT_EQ(0, steel.y.front());
...
TEST_F(OneSteelSphere, physics)
{
    ...
    }
    {
        ...
        EXPECT_SOFT_EQ(9549.651635687942, steel.xmin);
        EXPECT_SOFT_EQ(1e8, steel.xmax);
    }
    {
        ...
        // primary electrons
        EXPECT_SOFT_EQ(19099.303271375884, steel.xmin);
        EXPECT_SOFT_EQ(1e8, steel.xmax);
    }
    {
    ...
    }
    {
        ...
        {
            ASSERT_TRUE(pv);
            EXPECT_SOFT_EQ(1e-4, pv.xmin);
            EXPECT_SOFT_EQ(1e2, pv.xmax);
        }
    ...
    }
    {
        ...
        {
            ASSERT_TRUE(pv);
            EXPECT_SOFT_EQ(1e2, pv.xmin);
            EXPECT_SOFT_EQ(1e8, pv.xmax);
        }
        auto const& steel = msc.xs_table.physics_vectors.back();
