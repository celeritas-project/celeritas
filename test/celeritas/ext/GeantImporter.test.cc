...
class FourSteelSlabsEmStandard : public GeantImporterTest
{
    ...
    GeantPhysicsOptions build_geant_options() const override
    {
        ...
        if (CELERITAS_UNITS == CELERITAS_UNITS_CGS)
        {
            ...
            out.erase("_version");
            EXPECT_JSON_EQ(
                R"json({"_format":"geant-physics","_units":"cgs","angle_limit_factor":1.0,"annihilation":true,"apply_cuts":false,"brems":"all","cerenkov":true,"compton_scattering":true,"coulomb_scattering":false,"default_cutoff":0.1,"eloss_fluctuation":true,"em_bins_per_decade":7,"form_factor":"exponential","gamma_conversion":true,"gamma_general":false,"integral_approach":true,"ionization":true,"linear_loss_limit":0.01,"lowest_electron_energy":[0.001,"MeV"],"lpm":true,"max_energy":[100000000.0,"MeV"],"min_energy":[0.0001,"MeV"],"msc":"urban","msc_lambda_limit":0.1,"msc_range_factor":0.04,"msc_safety_factor":0.6,"msc_step_algorithm":"safety","msc_theta_limit":3.141592653589793,"optical_rayleigh":true,"photoelectric":true,"rayleigh_scattering":true,"relaxation":"all","scintillation":true,"verbose":true})json",
                std::string(out.dump()));
        }
        return opts;
    }
