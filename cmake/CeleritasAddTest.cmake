...
function(celeritas_add_test SOURCE_FILE)
  ...
  if(CELERITASTEST_PREFIX)
    set(_TARGET "${CELERITASTEST_PREFIX}_${_BASENAME}")
    if(PARSE_DEPTEST)
      set(PARSE_DEPTEST "${CELERITASTEST_PREFIX}_${PARSE_DEPTEST}")
    endif()
  ...
  if(PARSE_SUFFIX)
    ...
    if(PARSE_DEPTEST)
      set(PARSE_DEPTEST "${PARSE_DEPTEST}_${PARSE_SUFFIX}")
    endif()
