...
function(celeritas_add_test SOURCE_FILE)
  ...
  elseif(PARSE_REUSE_EXE)
   ...
   # message(WARNING: "${_TARGET} CELERITASTEST_LINK_LIBRARIES ${CELERITASTEST_LINK_LIBRARIES}")
   # message(WARNING: "${_TARGET} PARSE_LINK_LIBRARIES ${PARSE_LINK_LIBRARIES}")
   ...
   # message(WARNING: "${_TARGET} CELERITASTEST_ADD_DEPENDENCIES ${CELERITASTEST_ADD_DEPENDENCIES}")
   # message(WARNING: "${_TARGET} PARSE_ADD_DEPENDENCIES ${PARSE_ADD_DEPENDENCIES}")
    endif()
  endif()
