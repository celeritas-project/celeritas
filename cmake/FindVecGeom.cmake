...
if(
    VecGeom_FOUND
    AND (TARGET VecGeom::vecgeomcuda OR TARGET VecGeom::vecgeom_final)
)
        ...
        set_target_properties(
            ...
            PROPERTIES
                ...
                CUDA_RDC_MIDDLE_LIBRARY
                    VecGeom::vecgeomcuda${_vecgeom_middle_library_suffix}
                CUDA_RDC_FINAL_LIBRARY VecGeom::vecgeomcuda
        )
        set_target_properties(
            VecGeom::vecgeomcuda
            PROPERTIES CUDA_RDC_LIBRARY_TYPE Shared
            #CUDA_RUNTIME_LIBRARY ${_vecgeom_cuda_runtime}
        )
        set_target_properties(
            VecGeom::vecgeomcuda_static
            PROPERTIES CUDA_RDC_LIBRARY_TYPE Static
        )
    endif()
    ...
    foreach(_lib ${_vecgeom_cuda_libs})
        if(TARGET ${_lib})
            target_compile_options(
                ${_lib}
                INTERFACE
                    "$<$<COMPILE_LANGUAGE:CUDA>:SHELL: -Xnvlink --suppress-stack-size-warning>"
            )
            target_link_options(
                ${_lib}
                INTERFACE
                    "$<DEVICE_LINK:SHELL: -Xnvlink --suppress-stack-size-warning>"
            )
        endif()
    endforeach()
