    ...
    if(TARGET ${_lib})
      ...
      if(_libmid)
        ...
        foreach(_sublib ${_flat_midlist})
          ...
          if(_sublib STREQUAL "VecGeom::vecgeomcuda_static")
            #message("For  ${_sublib}, we have type -${_sublib_target_type}-")
          endif()
          if(_sublib_target_type STREQUAL "STATIC_LIBRARY")
            #message("Add the static library ${_sublib} to the ling list of ${target}")
            if(_stripped_lib)
