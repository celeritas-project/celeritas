...
define_property(
    ...
    BRIEF_DOCS
        "Name of the final library corresponding to this cuda library"
    FULL_DOCS
        "Name of the final library corresponding to this cuda library"
)
define_property(
    ...
    BRIEF_DOCS
        "Name of the static library corresponding to this cuda library"
    FULL_DOCS
        "Name of the static library corresponding to this cuda library"
)
define_property(
...
function(cuda_rdc_target_link_libraries target)
    ...
    cuda_rdc_use_middle_lib_in_property(
        ${_target_middle}
        INTERFACE_LINK_LIBRARIES
    )
    ...
    if(
        ...
        elseif(${_final_count} EQUAL 1)
            ...
            if(_final_target_type STREQUAL "STATIC_LIBRARY")
                ...
                cuda_rdc_cuda_gather_dependencies(
                    _flat_list_linked_libs
                    ${target}
                )
            ...
            if(NOT _lib_target_type STREQUAL "INTERFACE_LIBRARY")
                ...
                if(TARGET ${_libstatic})
                    ...
                    set_property(
                        ...
                        PROPERTY
                            LINK_DEPENDS
                                $<TARGET_FILE:${_libstatic}>
                    )

                    # Also pass on the the options and definitions.
                    cuda_rdc_transfer_setting(
                        ${_libstatic}
                        ${_target_final}
                        COMPILE_OPTIONS
                    )
